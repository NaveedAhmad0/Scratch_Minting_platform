	...
	return (
		<div id="home" className="mystyle">
			...
			<div className="container mt-5 mb-3 d-flex" id="collection">
				<div className="row rowcontainer123" >
