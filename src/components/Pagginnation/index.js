...
// import image1 from "../../../"
import image2 from "../../../src/images/nft2.jpeg";
import image3 from "../../../src/images/nft3.jpeg";
import image4 from "../../../src/images/nft4.jpeg";
import image5 from "../../../src/images/nft5.jpeg";
	...
	return (
		<div className="Container12 pag123 text-center">
			...
			<Carousel className="buttoncarousel" breakPoints={breakPoints} pagination={false} mode="gallery">
				...
				<Item>
					<img src={image2} className="image" alt="" style={{ height: 300 }} />
				</Item>
				<Item>
					<img src={image3} className="image" alt="" style={{ height: 300 }} />
				</Item>
				<Item>
					<img src={image4} className="image" alt="" style={{ height: 300 }} />
				</Item>
				<Item>
					<img src={image5} className="image" alt="" style={{ height: 300 }} />
				</Item>
				<Item>
					<img src={image1} className="image" alt="" style={{ height: 300 }} />
				</Item>
